...
chcp 65001 >nul
cd /d "%~dp0"
title afan Talking Video Agent - 8001
...
start "afan-talking-video-8001" /min cmd /c "python -m uvicorn app.main:app --host 127.0.0.1 --port 8001 > logs\server-8001.log 2>&1"
